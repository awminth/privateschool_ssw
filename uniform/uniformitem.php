                        ...
                        <div class="card-header">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="uniformitem_action.php">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Add Uniform Item</h4>
            ...
            <form id="frm" method="POST">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control boder-success" name="category">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control border-success" name="size">
                    </div>
                    <div class="form-group">
                        <label for="usr"> Price :</label>
                        <input type="number" class="form-control border-success" name="price">
                    </div>
                    <div class="form-group">
...
<div class="modal fade " id="editmodal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Edit Uniform Category</h4>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'uniform/uniformitem_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $(document).on("click", "#btnsave", function(e) {
        ...
        if (itemname == "" || category == "" || size == "" || price == "" || dt == "") {
    ...
    $(document).on("click", "#btnupdate", function(e) {
        ...
        var itemname = $("[name='eitemname']").val();
        var category = $("[name='ecategory']").val();
        var size = $("[name='esize']").val();
        var price = $("[name='eprice']").val();
        var dt = $("[name='edt']").val();
