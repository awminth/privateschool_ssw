                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <td>
                                        <form method="POST" action="saverecordgrade_action.php">
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'dailyteachingrecord/saverecordgrade_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $(document).on("click", "#btngograde", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                location.href = "<?=roothtml.'dailyteachingrecord/saverecordroom.php'?>";
            }
        });
    });
