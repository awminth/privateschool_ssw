...
$subjectcount = $_SESSION['subjectcount'];
...
if($action == 'show'){  
    ...
    $sql="select * from tblroom where GradeID={$gradeid} ".$a."  order by AID 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $sql_total="
        select * from tblroom where GradeID={$gradeid} ".$a."  order by AID";
