                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <td>
                                        <form method="POST" action="savetitle_action.php">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Add Save Title</h4>
            ...
            <input type="hidden" name="action" value="save"/>
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    <div class="form-group">
                        <label for="usr"> Learning Title :</label>
                        <select class="form-control boder-success select2" name="ltitle">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control boder-success select2" name="gname">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control boder-success select2" name="tname">
...
<div class="modal fade animate__animated flipInY" id="editmodal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Edit Learning Title</h4>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'dailyteachingrecord/savetitle_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
