                            ...
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                        ...
                                        <tr>
                                            <td>
                                                <button id="btnnew" type="button" class="btn btn-sm btn-<?=$color?>"><i
                                                        class="fas fa-plus"></i>&nbsp; <?=$lang['tea_bonuscut']?>
                                                </button>
                                            </td>
                                            <td>
                                                <form method="POST" action="teachersalary_action.php">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                <div class="form-group">
                                                    <label for="usr"> <?=$lang['tea_month']?> :</label>
                                                ...
                                                <button class="form-control btn btn-<?=$color?>"
                                                    id="btnsearch"><?=$lang['tea_search']?></button>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="card card-primary card-outline p-2">
                                                        ...
                                                        <td width="22%">
                                                            <div class="form-group row">
                                                                <label for="inputEmail3"
                                                                    class="col-sm-5 col-form-label"><?=$lang['tea_show']?></label>
                                                                <div class="col-sm-7">
                                ...
                                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel"
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <a href="<?=roothtml.'teacher/salarypay.php'?>" type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                ...
                                                <button class="form-control btn btn-<?=$color?>"
                                                    id="btnsearch1"><?=$lang['tea_search']?></button>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <div class="card card-primary card-outline p-2">
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'teacher/teachersalary_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
