...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?=$lang['home_managepaycategory']?></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <div class="card-header">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="paycategory_action.php">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">New Pay Type Category</h4>
...
<div class="modal fade animate__animated flipInY" id="editmodal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">Edit Pay Type Category</h4>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'stepup/paycategory_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
