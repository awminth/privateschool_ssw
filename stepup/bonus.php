...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><?=$lang['home_managesalarybonus']?></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <div class="card-header">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="bonus_action.php">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">New Bonus</h4>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'stepup/bonus_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
