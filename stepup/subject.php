                        ...
                        <div class="card-header">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="subject_action.php">
            ...
            <form id="frm" method="POST">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control border-success" id="category" name="name">
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'stepup/subject_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
