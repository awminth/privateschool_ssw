                        ...
                        <div class="card-header">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="grade_action.php">
            ...
            <form id="frm" method="POST">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <input type="number" class="form-control border-success" id="feeamt" name="feeamt" value="0">
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'stepup/grade_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
