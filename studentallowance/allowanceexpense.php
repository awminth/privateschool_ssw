...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Student Allowance Expense</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <td><a href="<?=roothtml.'studentallowance/expenseyear.php'?>" type="button"
                                    ...
                                    <td>
                                        <form method="POST" action="allowanceexpense_action.php">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header bg-<?=$color?>">
                <h4 class="modal-title">New Allowance Expense</h4>
            ...
            <form id="frm" method="POST">
                ...
                <div class='modal-body' data-spy='scroll' data-offset='50'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control border-success" id="rmk" name="rmk">
                    </div>
                    <div class="form-group">
