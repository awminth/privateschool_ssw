                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                                        ...
                                        aria-selected="true"><?=$lang['cms_expense']?></a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                                    ...
                                    <form method="POST" action="cms_action.php">
                                        <input type="hidden" name="hid">
                                        <input type="hidden" name="ser">
                                        <input type="hidden" name="dtfrom">
                                        <input type="hidden" name="dtto">
                                        <input type="hidden" name="dtpay">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                ...
                                                <div class="form-group">
                                                    <label for="usr">CMS :</label>
                                                    <select class="form-control border-success" name="cms">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="card card-primary card-outline p-2">
                                                ...
                                                <div class="form-group">
                                                    <label for="usr">CMS :</label>
                                                    <select class="form-control border-success" name="cms1">
                                                        <option value="">Select Pay</option>
                                                        <option value="cash">Cash</option>
                                                        <?=load_pay();?>
                                                    </select>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'cms/cms_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
