...
if($_POST["action"] == 'show'){  
    ...
    $sql="select l.*,u.UserName from tbllog l,tbllogin u 
    where Date(l.Date)>='{$from}' and Date(l.Date)<='{$to}' and
     l.LoginID=u.AID ".$a." order by l.AID desc 
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        $sql_total="select l.AID from tbllog l,tbllogin u 
        where Date(l.Date)>='{$from}' and Date(l.Date)<='{$to}' and
         l.LoginID=u.AID ".$a." order by l.AID desc";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        <table >  
            ...
            <tr>  
                ...
                <th style="border: 1px solid ;">'.$lang['log_description'].'</th>  
                <th style="border: 1px solid ;">UserName</th>  
                <th style="border: 1px solid ;">'.$lang['log_date'].'</th>
