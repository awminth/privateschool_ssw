                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <td>
                                        <a href="<?=roothtml.'ear/show_studentexam.php'?>" type="button"
                                ...
                                <div class="col-sm-8">
                                    <div class="card card-primary card-outline p-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="col-sm-8 form-control border-success" name="examtype">
...
$(document).ready(function() {
    function load_show_subject() {
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'ear/add_studentexam_action.php' ?>",
            data: {
                action: 'show_subject',
            },
            ...
            success: function(data) {
                if (data == 1) {
                    swal("Successful",
                        "Delete data success.",
                        "success");
                    location.href = "<?=roothtml.'ear/show_studentexam.php'?>";
                } else if (data == 2) {
                    swal("Warning", "Student exam data is already exit.", "warning");
                } 
                else if(data == 3){
                    swal("Data 3");
                }
