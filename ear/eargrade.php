                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <td><a href="<?=roothtml.'ear/ear.php'?>" type="button"
                                            class="btn btn-sm btn-<?=$color?>"><i class="fas fa-arrow-left"></i>&nbsp;
                                            <?=$lang['btnback']?>
                                        </a></td>
                                    <td>
                                        <form method="POST" action="eargrade_action.php">
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'ear/eargrade_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
    ...
    $(document).on("click", "#btngograde", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                location.href = "<?=roothtml.'ear/earstudent.php'?>";
            }
        });
    });
